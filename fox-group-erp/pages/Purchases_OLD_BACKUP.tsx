...
const Purchases: React.FC<PurchasesProps> = ({ products: initialProducts, suppliers: initialSuppliers, transactions: initialTransactions = [], onCompletePurchase, onReturnTransaction }) => {
